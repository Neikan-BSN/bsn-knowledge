...
def integrate_qdrant_vectors():
    ...
    qdrant_dir = "/home/user01/projects/bsn_knowledge/data/qdrant/medical_content_vectors"
    ...
    collection_config = {
        ...
        "metadata": {
            ...
            "average_accuracy": sum(v["umls_accuracy"] for v in vector_data) / len(vector_data),
    ...
    validation = {
        ...
        "accuracy_maintained": collection_config['metadata']['average_accuracy'] >= 0.98
    }

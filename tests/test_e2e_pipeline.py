...
class TestE2EPipeline:
    ...
    async def test_e2e_009_context_preservation_across_handoff(
        ...
        async with e2e_pipeline_client as client:
            ...
            personalized_content = bsn_result["personalized_content"]
    ...
    async def test_e2e_014_audit_trail_and_compliance_logging(
        ...
        async with e2e_pipeline_client as client:
            ...
            sensitive_access_logged = sensitive_response.status_code in [
                200,
                403,
            ]  # Either allowed and logged, or denied and logged

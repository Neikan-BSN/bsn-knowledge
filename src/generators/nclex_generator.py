...
"""
    ...
    async def generate_questions(
        ...
        try:
            ...
            logger.error(f"NCLEX question generation failed for topic '{topic}': {str(e)}")
            raise
    ...
    async def validate_question(self, question: NCLEXQuestion) -> Dict[str, Any]:
        ...
        try:
            ...
            if question.category not in self.nclex_categories:
                format_issues.append(f"Category must be one of: {self.nclex_categories}")
            ...
            return {
                ...
                "overall_score": validation.confidence_score if not format_issues else 0.0
            }
    ...
    async def generate_clinical_scenario_questions(
        ...
        """
        scenario_template = self.question_template + """
